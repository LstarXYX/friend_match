...
import com.lstar.project.mapper.UserMapper;
...
import static com.lstar.project.constant.ConstUser.ADMIN_ROLE;
import static com.lstar.project.constant.ConstUser.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public boolean userLogout(HttpServletRequest request) {
        if (request.getSession().getAttribute(USER_LOGIN_STATE) == null) {
            throw new AppException(Code.OPERATION_ERROR, "未登录");
        }
        // 移除登录态
