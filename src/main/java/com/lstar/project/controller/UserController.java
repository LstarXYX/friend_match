...
import com.lstar.project.model.dto.user.*;
import com.lstar.project.model.entity.User;
import com.lstar.project.model.vo.UserVO;
...
public class UserController {
     ...
     */
    @PostMapping("/login")
    public Response<User> userLogin(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
     ...
     */
    @GetMapping("/get")
    public Response<UserVO> getUserById(int id, HttpServletRequest request) {
        if (id <= 0) {
            throw new AppException(Code.PARAMS_ERROR);
        }
     ...
     */
    @GetMapping("/list")
    public Response<List<UserVO>> listUser(UserQueryRequest userQueryRequest, HttpServletRequest request) {
    ...
    public Response<Page<UserVO>> listUserByPage(UserQueryRequest userQueryRequest, HttpServletRequest request) {
        long current = 1;
        long size = 10;
        User userQuery = new User();
        if (userQueryRequest != null) {
